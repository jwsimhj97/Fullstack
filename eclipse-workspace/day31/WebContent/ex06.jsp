...
<body>
	<h1>페이지 이동</h1>
	<a href="ex05.jsp?id=admin&pw=abcd">go ex05.jsp</a>
	<form action="ex05.jsp">
		<input type="text" name="id" value="abcd"><br>
		<!-- <select name="pw" size="3">
		...
		<!-- <input type="checkbox" name="pw" value="aaaa"><br> -->
		<!-- <input type="hidden" name="pw" value="aaaa"><br> -->		
		<!-- <input type="password" name="pw" value="aaaa"><br> -->
		<textarea rows="5" cols="10" name="pw"></textarea><br>
